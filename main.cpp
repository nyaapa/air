...
int main(int argc, char** argv) {
	...
	options.add_options()("s,sleep-time", "sleep time between probes", cxxopts::value<uint>(sleep_time))(
	    "j,json", "response in json", cxxopts::value<bool>(json))("n,name", "name of that sender, required for sending", cxxopts::value<std::string>(name))(
	    "r,receiver", "receiver address, requires name", cxxopts::value<std::string>(receiver))("h,help", "Print help");
